 ...
 */
    ...
    window.timing = window.timing || {
        ...
        getTimes: function(opts) {
            ...
            if (timing) {
                ...
                // 用户可操作时间
                api.operateTime = timing.domContentLoadedEventEnd - timing.navigationStart;
                // first byte
                api.firstByte = timing.responseStart - timing.navigationStart; 
            }
    ...
    // console.log(window.timing.getTimes());
    window.timing.printSimpleTable();
    // window.timing.printTable();
